...
function Breadcrumb() {
  // The route handles read the retained snapshots imperatively; these subscriptions make a
  // rename recompute them without acquiring another consumer of either store. The sidebar
